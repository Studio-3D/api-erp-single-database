...
<div class="container">
    ...
    <div class="header-container">
        ...
        <div class="header-right">
            ...
            @else
                <div class="text-sm font-bold text-[#0d4a35] border border-[#b8973a] rounded px-2 py-1 inline-block bg-[#e8f5e9]">
    ...
    <div class="content">
        ...
        {{-- PAYMENT - Single Avance with correct labels --}}
        @php
            $avance = $allAvances[0] ?? [];
            ...
            $numRecu = $avance['num_recu'] ?? '';

            // Build payment description matching frontend logic
            $paymentDescription = '';

            if ($modePaiement == 1) {
                $paymentDescription = 'Un paiement en espèces';
            } elseif (in_array($modePaiement, [2, 3, 4])) {
                if ($modePaiement == 2) {
                ...
                if ($banqueNom) {
                    $paymentDescription .= ' domicilié à ' . $banqueNom;
                }
                if ($numeroPaiement) {
                    $paymentDescription .= ', n° ' . $numeroPaiement;
                }
