...
class StoreReservationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Code réservation
            'code_reservation.required' => 'Le champ code de réservation est obligatoire.',
            'code_reservation.string' => 'Le code de réservation doit être une chaîne de caractères.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'code_reservation' => 'code de réservation',
            'prix' => 'prix',
